...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const finalMetrics = world.metricsHistory[world.metricsHistory.length - 1] ?? {
      ...
      inFlightExecutions: 0, avgSettlementLatencySteps: 0,
      p50SettlementLatencySteps: 0, p95SettlementLatencySteps: 0,
      totalLiquidityReplenished: 0, totalExternalLiquidityInjected: 0,
